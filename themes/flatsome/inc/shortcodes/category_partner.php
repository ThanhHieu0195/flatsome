...
function flatsome_category_partner_shortcode($atts, $content = null, $tag)
{
  $sliderrandomid = rand();
  extract(shortcode_atts(array(
    ...
    'columns__md' => '',
    'col_spacing' => 'small',
    'type' => 'masonery', // slider, row, masonery, grid
    'width' => '',
    'grid' => '1',
    'grid_height' => '600px',
  ...
  $product_categories = get_terms('partner_item_category', $args);
  ...
  if ($product_categories) {
    foreach ($product_categories as $category) {
      ...
      $image = wp_get_attachment_image_src(get_field("thumbnail", $category, ""));
      $image = $image[0];

      $icon = wp_get_attachment_image_src(get_field("icon", $category, ""));
      $icon = $icon[0];
            ...
            <div class="box-text <?php echo implode(' ', $classes_text); ?>" <?php echo get_shortcode_inline_css($css_args); ?>>
              <div class="box-text-inner">
                <h5 class="uppercase header-title">
                  <picture>
                    <img style="position: relative; margin-bottom: 0em; margin-top: -40px; z-index: 99;" width="60px" src="<?= $icon ?>" alt="">
                  </picture>
...
add_shortcode("ux_category_partner", "flatsome_category_partner_shortcode");
