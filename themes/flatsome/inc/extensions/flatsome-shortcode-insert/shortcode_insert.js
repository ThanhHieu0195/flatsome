(function () {
          ...
          menu: [
            {
              text: "Simple slider",
              value:
                '[ux_slider timer="4500" arrows="true" bullets="true" auto_slide="true" nav_color="dark"]<br> Insert slides here (UX Banner or Sections) <br>[/ux_slider]',
              onclick: function (e) {
                e.stopPropagation();
            ...
            },
            {
              ...
              value:
                '[ux_slider timer="4500" arrows="true" bullets="false" auto_slide="true" nav_color="dark"]<p>[col span="1/4"] Content [/col]<br/><br>[col span="1/4"] Content [/col]<br/><br>[col span="1/4"] Content [/col]<br/><br>[col span="1/4"] Content [/col]<br/><br>[col span="1/4"] Content [/col]<br/></p>[/ux_slider]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
            },
            {
              ...
              value:
                '[ux_slider height="60px" arrows="true" bullets="false" nav_color="dark" margin="0px"]<br><br/>[logo title="Logo title" img="http://imageurl" height="60px"]<br/><br/>[logo title="Logo title" img="http://imageurl" height="60px"]<br/><br/>[logo title="Logo title" img="http://imageurl" height="60px"]<br/><br/>[logo title="Logo title" img="http://imageurl" height="60px"]<br/><br/>[logo title="Logo title" img="http://imageurl" height="60px"]<br/>[logo title="Logo title" img="http://imageurl" height="60px"]<br/><br/>[logo title="Logo title" img="http://imageurl" height="60px"]<br/><br/>[/ux_slider]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
        ...
        },
        {
          ...
          menu: [
              ...
              menu: [
                {
                  ...
                  value:
                    '[featured_box title="Title text" img="http://iconurl" img_width="" pos="center" link=""]<p>Featured box text</p>[/featured_box]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  text: "Icon Top",
                  value:
                    '[featured_box title="Title text" img="http://iconurl" img_width="" link=""]<p>Featured box text</p>[/featured_box]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  text: "Icon Left",
                  value:
                    '[featured_box title="Title text" pos="left" img="http://iconurl" img_width="" link=""]<p>Featured box text</p>[/featured_box]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
            ...
            },
            {
              ...
              menu: [
                ...
                },
                {
                  text: "Button - Alert",
                  value:
                    '[button size="medium" style="alert"  text="Medium button" link="http://" target=""]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                ...
                },
                {
                  text: "Button - White",
                  value:
                    '[button size="medium" style="white"  text="Medium button" link="http://"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  ...
                  value:
                    '[button size="medium" style="is-outline primary"  text="Medium button" link="http://" target=""]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  ...
                  value:
                    '[button size="medium" style="is-outline secondary"  text="Medium button" link="http://" target=""]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  ...
                  value:
                    '[button size="medium" style="is-outline success"  text="Medium button" link="http://"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  ...
                  value:
                    '[button size="medium" style="is-outline white"  text="Medium button" link="http://"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
              ...
              menu: [
                {
                  ...
                  value:
                    '[tabgroup title="Tab group title"]<br>[tab title="Tab 1 Title"] Tab content [/tab]<br>[tab title="Tab 2 Title"] Tab content [/tab]<br>[tab title="Tab 3 Title"] Tab content [/tab]<br>[/tabgroup]<br>',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  ...
                  value:
                    '[tabgroup style="center" title=""]<br>[tab title="Tab 1 Title"] Tab content [/tab]<br>[tab title="Tab 2 Title"] Tab content [/tab]<br>[tab title="Tab 3 Title"] Tab content [/tab]<br>[/tabgroup]<br>',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  ...
                  value:
                    '[tabgroup style="pills" title=""]<br>[tab title="Tab 1 Title"] Tab content [/tab]<br>[tab title="Tab 2 Title"] Tab content [/tab]<br>[tab title="Tab 3 Title"] Tab content [/tab]<br>[/tabgroup]<br>',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  text: "Tabs - Vertical",
                  value:
                    '[tabgroup_vertical title=""]<br>[tab title="Tab 1 Title"] Tab content [/tab]<br>[tab title="Tab 2 Title"] Tab content [/tab]<br>[tab title="Tab 3 Title"] Tab content [/tab]<br>[/tabgroup_vertical]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
            ...
            },
            {
              text: "Map",
              value:
                '[map lat="40.79028" long="-73.95972" height="500px" color="#58728a"] Enter map content here.. [/map]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
            },
            {
              ...
              menu: [
                ...
                },
                {
                  ...
                  value:
                    '[blog_posts columns="3" style="text-overlay" posts="8" category="" image_height="150px" show_date="true"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
            ...
            },
            {
              ...
              menu: [
                ...
                },
                {
                  ...
                  value:
                    '[title text="This is a title" link="#" link_text="Title link"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                ...
                },
                {
                  ...
                  value: '[divider width="150px" color="var(--primary-color)"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
              ...
              menu: [
                {
                  text: "Follow Icons",
                  value:
                    '[follow twitter="http://" facebook="http://" email="email@post.com" pinterest="http://" rss="http://" instagram="http://" googleplus="http://"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
                },
                {
                  ...
                  value:
                    '[follow size="small" twitter="http://" facebook="http://" email="email@post.com" pinterest="http://" rss="http://" instagram="http://" googleplus="http://"]',
                  onclick: function (e) {
                    e.stopPropagation();
                    editor.insertContent(this.value());
                  },
...

            {
              text: "Price Table",
              value:
                '[ux_price_table price="99$" title="Awesome title" featured="false" description="This is a description" button_text="Order Now" button_link="#"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[/ux_price_table]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
            },
            {
              text: "Testimonial",
              value:
                '[testimonial style="" image="http://imageurl" name="Author name" company="Company name" stars="5"]<br> Add testimonial text here <br>[/testimonial]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
            },
            {
              text: "Team Member",
              value:
                '[team_member name="Name" title="Title" facebook="http://" twitter="http://" pinterest="http://"  img="http://imageurl"]<br>Team member description<br>[/team_member]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
            },
            {
              text: "Message Box",
              value:
                '[message_box bg="#hex or http://imageurl"] Message box text [/message_box]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
        ...
        },
        {
          ...
          menu: [
            ...
            },
            {
              ...
              value:
                '[products_pinterest_style products="" cat="category-slug" columns="4"]',
              onclick: function (e) {
                e.stopPropagation();
                editor.insertContent(this.value());
              },
  ...
  function ux_add_uxbanner(editor) {
    var list_style =
      "height:90px; width:130px; text-indent: -999px; text-align:center;padding-top:3px; background-repeat:no-repeat;font-size:10px!important;border-top:1px solid #555;";
    ...
    editor.windowManager.open({
      ...
      body: [
        ...
        },
        {
          ...
          values: [
            {
              text: "Text Center",
              value: 'text_align="center" text_pos="center" text_width="70%"',
              style:
                list_style +
            ...
            },
            {
              text: "Text Left",
              value:
                'text_align="left" text_pos="left center" text_width="40%" text_bg=""',
              style:
                list_style +
            ...
            {
              text: "Text Left Centered",
              value:
                'text_align="center" text_pos="left center" text_width="40%" text_bg=""',
              style:
                list_style +
            ...
            },
            {
              text: "Text Right",
              value:
                'text_align="right" text_pos="right center" text_width="40%" text_bg=""',
              style:
                list_style +
            ...
            {
              text: "Text Right Centered",
              value:
                'text_align="center" text_pos="right center" text_width="40%" text_bg=""',
              style:
                list_style +
            ...
            },
            {
              ...
              value:
                'text_align="center" text_pos="bottom center" text_width="40%" text_bg=""',
              style:
                list_style +
            ...
            },
            {
              text: "Text Top Left",
              value:
                'text_align="left" text_pos="left top" text_width="40%" text_bg=""',
              style:
                list_style +
            ...
            },
            {
              ...
              value:
                'text_align="center" text_pos="top center" text_width="70%" text_bg=""',
              style:
                list_style +
            ...
            {
              text: "Boxed Text Left",
              value:
                'text_align="left" text_pos="left center" text_width="40%" text_bg="#000" text_bg_opacity=0.8" padding="30px"',
              style:
                list_style +
            ...
            {
              text: "Boxed Text Right",
              value:
                'text_align="left" text_pos="right center" text_width="40%" text_bg="#000" text_bg_opacity=0.8" padding="30px"',
              style:
                list_style +
            ...
            {
              text: "Boxed Text Center",
              value:
                'text_align="center" text_pos="center" text_width="40%" text_bg="#000" text_bg_opacity=0.8" padding="30px"',
              style:
                list_style +
            ...
            {
              text: "Boxed Badge style",
              value:
                'text_align="center" text_pos="bottom full-width" text_bg="#000" text_bg_opacity=0.8" padding="10px"',
              style:
                list_style +
          ...
          values: [
            {
              text: "Default",
              value:
                '<h4 class="alt-font">Smaller On Top</h4><p>___</p><h1>BIG HEADLINE</h1><h4 class="thin-font">A smaller text under headline</h4><p>[button text="button" link="#" size="medium" style="is-outline white"]</p>',
              style:
                list_style +
            ...
            },
            {
              text: "Big banner",
              value:
                '<h3 class="alt-font">Smaller On Top</h3><p>____</p><h1 class="h-large">BIG HEADLINE</h1><h4 class="thin-font">A smaller text under headline</h4><p>[button text="button" link="#" size="medium" style="is-outline white"] <br>[button text="button" link="#" size="medium" style="is-outline white"] <br>[button text="button" link="#" size="medium" style="is-outline white"]</p>',
              style:
                list_style +
            ...
            },
            {
              text: "Simple",
              value:
                '<h1>BIG HEADLINE</h1><h4 class="thin-font">A smaller text under headline</h4>',
              style:
                list_style +
            ...
            {
              text: "Simple two buttons",
              value:
                '<h2>BIG HEADLINE</h2><h4 class="thin-font">A smaller text under headline</h4><p>[button text="button" link="#" size="medium" style=""] <br>[button text="button" link="#" size="medium" style="is-outline"]</p>',
              style:
                list_style +
            ...
            {
              text: "Bordered Headline",
              value:
                '<h2 class="text-bordered-white">BIG HEADLINE</h2><h4 class="thin-font">A smaller text under headline</h4>',
              style:
                list_style +
      ...
      onsubmit: function (e) {
        var banner_content =
          ...
          e.data.height +
          " " +
          e.data.banner_effect +
          "][text_box " +
          e.data.text_color +
          " " +
          e.data.text_layout +
          "  " +
          e.data.parallax_text +
          " " +
          e.data.text_animation +
          "] " +
          e.data.text_content +
          " [/text_box] [/ux_banner]";
    ...
    editor.windowManager.open({
        ...
        },
        {
          ...
          values: [
            { text: "Blank", value: "Insert content here...<br>" },
            {
              text: "Text",
              value:
                "<h3>Add a title here</h3>[divider]<p>Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</p>",
            },
            {
              text: "Featured Box - Icon Top",
              value:
                '[featured_box title="Title text" img="http://iconurl" img_width="" pos="center" link=""]<p>Featured box text</p>[/featured_box]<br>',
            },
            {
              text: "Featured Box - Icon Left",
              value:
                '[featured_box title="Title text" img="http://iconurl" img_width="" pos="left" link=""]<p>Featured box text</p>[/featured_box]<br>',
            },
            {
              text: "Team Members",
              value:
                '[team_member name="Name" title="Title" facebook="http://" twitter="http://" pinterest="http://"  img="http://imageurl"]<br>Team member description<br>[/team_member]<br>',
            },
            {
              text: "Price Table",
              value:
                '[ux_price_table title="Awesome title" featured="false" description="This is a description" button_text="Order Now" button_link="#"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[/ux_price_table]<br>',
            },
            {
              text: "Testimonial",
              value:
                '[testimonial image="http://imageurl" name="Author name" company="Company name" stars="5"]<br> Add testimonial text here <br>[/testimonial]<br>',
            },
          ],
        },
      ],
      onsubmit: function (e) {
        if (e.data.columns == "1") {
          var insertContent =
            '[col span="1/1" ' +
            e.data.columns_hover +
            " " +
            e.data.column_animate +
            "]<br>" +
            e.data.column_content +
            "<br/>[/col]<br>";
        }
        if (e.data.columns == "2") {
          var insertContent =
        ...
        editor.insertContent(
          "[row " + e.data.row_style + "]<p>" + insertContent + "</p>[/row]<br>"
        );
      },
    });
  }
  ...
  function UXgalleryModal() {
    ...
    file_frame.on("select", function () {
      ...
      jQuery(".mce-i-icon.dashicons-format-gallery")
        .parent()
        .addClass("image-bg-button");
      jQuery(".mce-i-icon.dashicons-format-gallery")
        .parent()
