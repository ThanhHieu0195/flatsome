...
if (is_partner_activated()) {
  require get_template_directory() . '/inc/shortcodes/partner.php';
  require get_template_directory() . '/inc/shortcodes/category_partner.php';
}
...
if (is_woocommerce_activated()) {
  require get_template_directory() . '/inc/widgets/widget-upsell.php';
}
...
if (is_partner_activated()) {
  require get_template_directory() . '/inc/post-types/post-type-ux-partner.php';
}
